package com.easybuy.goods.service.impl;

import com.easybuy.goods.dao.*;
import com.easybuy.goods.pojo.*;
import com.easybuy.goods.service.SpuService;
import com.easybuy.util.IdWorker;
...
public class SpuServiceImpl implements SpuService {
    ...
    public void add(GoodsDto goodsDto){
        ...
        //添加sku集合
        this.saveSkuList(goodsDto);
    }

    //添加sku数据
    private void saveSkuList(GoodsDto goodsDto) {
        Spu spu = goodsDto.getSpu();
        //设置品牌与分类的关联关系
        ...
        if (skuList != null) {
            ...
            for (Sku sku : skuList) {
                ...
                try {
                    specMap = objectMapper.readValue(sku.getSpec(), new TypeReference<Map<String, String>>() {
                    });
    ...
    public void delete(String id) {
        //查询spu，判断当前商品是否处于下架状态
        Spu spu = spuMapper.selectByPrimaryKey(id);
        //如果是下架状态，则修改相对应的标记位，进行逻辑删除
